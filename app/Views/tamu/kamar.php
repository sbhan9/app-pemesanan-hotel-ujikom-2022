               ...
               <div class="col-lg-3 mx-2 mt-3">
                  <div class="card card-kamar">
                     ...
                     <div class="card-body">
                        ...
                        <a href="<?= base_url('/page-tamu/booking-now/'.$k['kode_kamar']) ?>"
            ...
            <div class="keur-tablet">
               ...
               <div class="col-lg-3 mx-2 mt-3">
                  <div class="card card-kamar">
                     <div class="no-kamar">
                        <span class="bg-info p-1 rounded text-light">No. <?= $no++ ?></span>
                        <span class="bg-danger p-1 rounded text-light">Sisa <?= $k['stok_kamar'] ?> Kamar</span>
                     </div>
                     <img src="<?= base_url('/assets/img/kamar.jpeg') ?>" class="card-img-top p-2 img-kamar" />
                     <div class="card-body">
                        <h4 class="card-title text-center"><?= $k['tipe_kamar'] ?></h4>
                        <?php // mengubah data fasilitas menjadi array ?>
                        <?php $fasilitas = explode(',', $k['fasilitas']) ?>
                        ...
                        <a href="<?= base_url('/page-tamu/booking-now'.$k['id_kamar']) ?>"
                           class="btn btn-primary w-100">Pesan
                           Sekarang</a>
                     </div>
                  </div>
      ...
      <div class="row">
         ...
         <div class="col-lg-3 col-sm-6 mt-3">
            <div class="card">
               ...
               <img src="<?= base_url('/assets/img/'.$f['foto_fasilitas']) ?>" class="card-img-top p-2 img-kamar" />
               <div class="card-body">
                  ...
                  <a href="<?= base_url('/page-tamu/booking-now') ?>" class="btn btn-primary w-100">Pesan Sekarang</a>
               </div>
            </div>
         </div>
         <?php endforeach ?>
