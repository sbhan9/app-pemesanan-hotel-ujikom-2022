         ...
         <div class="col">
            <div class="card card-reservasi" data-aos="fade-down">
               <div class="card-body">
                  ...
                  <form class="d-inline" action="<?= base_url('/masuk') ?>">
                     <div class="row">
                        <div class="col-lg-3">
                           <div class="mb-3">
                              <label for="check_in" class="form-label">Check-In</label>
                              <input type="date" min="<?= date('m/d/Y') ?>" name="check_in" class="form-control"
                                 id="check_in" />
                           </div>
                        </div>
                        <div class="col-lg-3">
                        ...
                        <div class="col-lg-3">
                           <div class="mb-3">
                              ...
                              <select id="inputState" name="tipekamar" class="form-select" onchange="jalanKeunHarga()">
                                 ...
                                 <option value="<?= $k['harga'] ?>"><?= $k['tipe_kamar'] ?></option>
                                 <?php endforeach ?>
                              </select>
                           </div>
                        </div>
                        <div class="col-lg-3">
                           <div class="mb-3">
                              <label for="harga_hari" class="form-label">Harga/Hari</label>
                              <input type="text" class="form-control" name="harga" id="harga_hari" readonly />
                           </div>
                        </div>
                     </div>
                     <button type="submit" class="btn btn-primary w-100 mb-3">Pesan Sekarang</button>
                  </form>
               </div>
            </div>
         </div>
